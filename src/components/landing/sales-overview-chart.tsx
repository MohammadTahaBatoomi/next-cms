...
import { Card, CardContent, Typography, Select, MenuItem, IconButton } from '@mui/material';
...
<Card className="mr-6 w-3xl mx-auto">
      <CardContent>
        <div className="flex justify-between items-center mb-8">
          <Typography variant="p" className="font-medium">Sales Overview</Typography>
        ...
        <div className="h-88 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} barCategoryGap={20} >
              ...
              <Tooltip />
              <Bar dataKey="uv" fill="#7499ff" radius={[8, 8, 0, 0]} barSize={10} />
              <Bar dataKey="pv" fill="#66c8ff" radius={[8, 8, 0, 0]} barSize={10} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
